...
public class AttributesMap extends HashMap<String, String> {
    ...
    /**
     * This method returns true if the given {@link org.xml.sax.Attributes} contains the same
     * attributes as this map, with the same qualifications for "style" and "class"
     * as specified in {@link org.outerj.daisy.diff.html.dom.helper.AttributesMap#equals(Object)}.
     */
